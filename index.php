...
<body> -->
    ...
    <!--            <div class="modal-content"style="width: 800px!important;margin-left:-150px;margin-top:200px" >-->
    <!--                <div class="modal-header" style="background-color:blue">-->
    <!--                    <h5 class="modal-title text-white">Modern Technology</h5>-->
    ...
    <!--                    <div class="row">-->
    <!--                        <div class="col-lg-6">-->
    <!--                            <img src="https://www.transparentpng.com/thumb/technology/technology-simple-17.png" alt="">-->
    <!--                        </div>-->
    <!--                        <div class="col-lg-6">-->
    <!--                            <p class="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint ab saepe assumenda deserunt maxime laudantium harum delectus numquam ex earum quae libero minima corrupti, perferendis dicta molestiae excepturi beatae nisi.</p>-->
    <!--                        </div>-->
    <!--                    </div>-->
                    ...
                    <div class="col-lg-6">
                        <div class="info">
                            <div class="section-head mb-60">
                                <h6 class="color-main text-uppercase">Morden Technology</h6>
                                <h2>
                                    Need Better Plan To  <span class="fw-normal">Start Business</span>
                                </h2>
                            </div>
                            <div class="text">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="portfolio-card">
                                    ...
                                    <div class="info">
                                        <h5>
                                            <a href="singlePost.php"> Raichandgroup </a> 
                                        </h5>
                                        <small class="d-block color-main text-uppercase"><a href="#">WebSite Developemnt</a></small>
                                        <div class="text">
                                            Trust our top minds to eliminate workflow pain points, implement new tech & app.
                                        </div>
                                        <div class="tags">
                            ...
                            <div class="swiper-slide">
                                <div class="portfolio-card">
                                    ...
                                    <div class="info">
                                        <h5>
                                            <a href="singlePost.php"> Modern Technology </a> 
                                        </h5>
                                        <small class="d-block color-main text-uppercase"><a href="#">Website Development,</a> <a href="#">UI/UX Design</a></small>
                                        <div class="text">
                                            Trust our top minds to eliminate workflow pain points, implement new tech & app.
