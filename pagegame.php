                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-head text-center mb-60 style-5">
                            <h2 class="mb-20"> Game <span> Development </span> </h2>
                            <p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8 order-0 order-lg-2">
                            <div class="img main-img1">
                                ...
                                <img src="https://wcc1-website-assets.s3-ap-southeast-1.amazonaws.com/s3fs-public/bbl-players.png" alt="" class="img-body" >
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <div class="img main-img2">
                                ...
                                <img src="https://dazeinfo.com/wp-content/uploads/2018/07/top-apps-on-Apple-App-Store.jpg"  alt="" class="img-body">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="section-head mb-30 style-5">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="img">
                                <img src="https://www.dotcominfoway.com/wp-content/uploads/2020/05/mobile-game-app-development-company.png" alt="" class="img-body">
            ...
            <div class="content pb-0 mt-5">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-2 order-lg-0">
                        <div class="img">
                                <img src="https://i.pinimg.com/originals/66/5b/81/665b81c754d9f49917564adfde4ecadd.jpg" alt="" class="img-body">
            ...
            <div class="content pb-0 mt-5">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-0 order-lg-2">
                        <div class="img">
                                <img src="https://appdevelopmentcompanies.co/front_assets/img/category/mobile_9.jpg" alt="" class="img-body">
            ...
            <div class="content pb-0 mt-5">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-2 order-lg-0">
                        <div class="img">
                                <img src="https://artoonsolutions.com/wp-content/uploads/2019/06/Game-App-Development.png" alt="" class="img-body">
